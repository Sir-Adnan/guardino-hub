...
ensure_kv_if_missing "USAGE_SYNC_REMOTE_MISSING_MIN_HOURS" "6"
...
echo "USAGE_SYNC_REMOTE_MISSING_MIN_HOURS=$(grep -E '^USAGE_SYNC_REMOTE_MISSING_MIN_HOURS=' .env | cut -d= -f2-)"
